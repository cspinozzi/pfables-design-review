...
export function RefundModal({
  ...
  const handleSubmit = async () => {
    ...
    toast.success("Refund request submitted", {
      description: "We'll review your request and get back to you within 3-5 business days.",
    })
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Submit a refund request for this transaction. We&apos;ll review your request and respond within 3-5 business days.
          </DialogDescription>
        </DialogHeader>
