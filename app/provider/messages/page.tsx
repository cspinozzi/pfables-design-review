...
export default function ProviderMessagesPage() {
  ...
  useEffect(() => {
    ...
    if (convParam && providerConversations.some((c) => c.id === convParam)) {
      setSelectedConversation(convParam)
    }
  }, [searchParams, providerConversations])
  const selectedConv = providerConversations.find((c) => c.id === selectedConversation)
    ...
    <div className="min-h-screen bg-background pb-20 sm:pb-0">
          ...
          <div className="h-full flex flex-col bg-background">
            <div className="border-b bg-background px-4 py-4 flex items-center justify-between">
              ...
              <div className="text-sm text-muted-foreground">
                {providerConversations.length} {providerConversations.length === 1 ? "conversation" : "conversations"}
              </div>
            </div>
              ...
              {providerConversations.length === 0 ? (
                <div className="flex flex-col items-center justify-center p-8 text-center h-full">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm">
                    When parents contact you, their messages will appear here
                  </p>
                </div>
              ) : (
      ...
      <div className="hidden md:block page-container py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1 text-sm">Your conversations with parents</p>
        </div>
