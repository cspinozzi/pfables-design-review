    ...
    <div className="min-h-screen bg-background pb-20 sm:pb-12">
      ...
      <div className="mx-auto max-w-[1200px] px-6 sm:px-8 lg:px-12 py-8 sm:py-10 lg:py-12">
        <div className="mb-8 sm:mb-10">
          ...
          <p className="text-sm text-muted-foreground md:text-base">Choose the perfect plan for your repair business</p>
        </div>
        ...
        <Card className="mt-6">
          <CardContent className="p-5">
            ...
            <div className="space-y-3">
              {[
                { date: "2025-01-01", amount: 59, status: "paid", invoice: "INV-R-2025-001" },
                { date: "2024-12-01", amount: 59, status: "paid", invoice: "INV-R-2024-012" },
                { date: "2024-11-01", amount: 59, status: "paid", invoice: "INV-R-2024-011" },
              ].map((payment) => (
                <div
                  key={payment.invoice}
